...
void action_change_screen(lv_event_t *e)
{
    ...
    lv_obj_clear_state(objects.power_page_bottom_toolbar__bottom_nav_bar_button_home, LV_STATE_CHECKED);
    ...
    lv_obj_clear_state(objects.power_page_bottom_toolbar__bottom_nav_bar_button_trailer, LV_STATE_CHECKED);
    ...
    lv_obj_clear_state(objects.power_page_bottom_toolbar__botttom_nav_bar_button_power, LV_STATE_CHECKED);
    ...
    lv_obj_clear_state(objects.power_page_bottom_toolbar__botttom_nav_bar_button_solar, LV_STATE_CHECKED);
    ...
    lv_obj_clear_state(objects.power_page_bottom_toolbar__botttom_nav_bar_button_settings, LV_STATE_CHECKED);
