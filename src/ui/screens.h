...
typedef struct _objects_t {
    ...
    lv_obj_t *obj0__botttom_nav_bar_button_solar;
    ...
    lv_obj_t *power_page_bottom_toolbar;
    lv_obj_t *power_page_bottom_toolbar__bottom_nav_bar_button_home;
    lv_obj_t *power_page_bottom_toolbar__bottom_nav_bar_button_trailer;
    lv_obj_t *power_page_bottom_toolbar__botttom_nav_bar_button_power;
    lv_obj_t *power_page_bottom_toolbar__botttom_nav_bar_button_solar;
    lv_obj_t *power_page_bottom_toolbar__botttom_nav_bar_button_fridge;
    lv_obj_t *power_page_bottom_toolbar__botttom_nav_bar_button_settings;
    lv_obj_t *obj1;
