...
enum FlowGlobalVariables {
    FLOW_GLOBAL_VARIABLE_SOLAR_WATTAGE = 0,
    FLOW_GLOBAL_VARIABLE_SOLAR_STATUS = 1,
    FLOW_GLOBAL_VARIABLE_SHORE_POWER_CONNECTION_STATUS = 2,
    FLOW_GLOBAL_VARIABLE_BATTERY_SOC_PERCENTAGE = 3,
    FLOW_GLOBAL_VARIABLE_BATTERY_VOLTAGE = 4,
    FLOW_GLOBAL_VARIABLE_CURRENT_POWER_CONSUMPTION_IN_WATTS = 5,
    FLOW_GLOBAL_VARIABLE_POWER_TIME_TO_GO_MEASUREMENT = 6,
    FLOW_GLOBAL_VARIABLE_POWER_TIME_TO_GO_MEASUREMENT_TYPE = 7,
    FLOW_GLOBAL_VARIABLE_PDM01_DEVICE01_STATUS = 8,
    FLOW_GLOBAL_VARIABLE_PDM01_DEVICE02_STATUS = 9,
    FLOW_GLOBAL_VARIABLE_PDM01_DEVICE03_STATUS = 10,
    FLOW_GLOBAL_VARIABLE_PDM01_DEVICE04_STATUS = 11,
